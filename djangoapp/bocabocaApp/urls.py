...
urlpatterns = [
    ...
    path('register_client/', app_views.register_client_view, name='register_client'),
    ...
    path('new_user/edit/<str:username>/', profile_views.new_user, name='edit_new_user'),
    path('new_user/edit/<str:username>/', profile_views.new_client, name='edit_new_client'),
    #path('activation_success/<str:email>/', profile_views.activation_success, name='activation_success'),
    #path('activation_client_success/<str:email>/', profile_views.activation_client_success, name='activation_client_success'),
